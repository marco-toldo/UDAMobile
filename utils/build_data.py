...
tf.flags.DEFINE_string('data_dir', '../../data/SYNTHIA/', 'data directory')
tf.flags.DEFINE_string('data_list', '../../data/SYNTHIA/val.txt', 'data_list')
tf.flags.DEFINE_string('output_file', '../../data/tfrecords/SYNTHIA/val.tfrecords', 'output tfrecords file')
